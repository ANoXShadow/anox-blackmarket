...
CreateThread(function()
    PerformHttpRequest("https://raw.githubusercontent.com/ANoXShadow/anox-blackmarket/main/version.txt", function(err, latestVersion, headers)
        ...
        if currentVersion ~= latestVersion then
            ...
            print("^1Download the latest version: https://github.com/ANoXShadow/anox-blackmarket^0")
        else
